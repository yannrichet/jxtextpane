...
import org.irsn.javax.swing.BlockModeHandler;
import org.irsn.javax.swing.DefaultSyntaxColorizer;
import org.irsn.javax.swing.DocumentFilterChain;
import org.irsn.javax.swing.JXTextPane;
import org.irsn.javax.swing.LineWrapEditorKit;
    ...
    public static void main(String a[]) throws BadLocationException, Exception {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    edit.setText(read("src/main/java/org/irsn/javax/swing/JXTextPane.java"));
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
        ...
        DocumentFilterChain df = new DocumentFilterChain(new DefaultSyntaxColorizer(edit, syntax2),new BlockModeHandler(edit));
